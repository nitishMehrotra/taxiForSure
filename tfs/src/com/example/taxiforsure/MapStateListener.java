package com.example.taxiforsure;
...
public abstract class MapStateListener {
				...
				mActivity.runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						if (currentPosition.equals(mLastPosition)) {
							settleMap(currentPosition.target);
						}
					}
				});
			}
	...
	public void settleMap(LatLng position) {
		if (!mMapSettled) {
			mMapSettled = true;
			onMapSettled(position);
		}
	}
	...
	public abstract void onMapSettled(LatLng position);
}